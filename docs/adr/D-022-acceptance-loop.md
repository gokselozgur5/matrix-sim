...
**Human-subject disposition (D-064, 2026-08-19):** This record remains accepted as the historical film profile's acceptance loop and system-instability mechanism. Its residue and `AnomalyLedger` are not a resident belief model and not an accountable actor's contract debt. [D-064](D-064-reciprocal-debt.md) supersedes only that broader human-ontology reading: mind-owned epistemic resistance and actor-owned breach/repair obligations now have separate owners and conservation laws. No D-022 runtime byte is renamed or reinterpreted by the decision.

Referenced by: [D-033](D-033-self-substantiation.md), [D-064](D-064-reciprocal-debt.md).
