...
Referenced by: [D-063](D-063-outcome-first-delivery.md), [D-064](D-064-reciprocal-debt.md), [D-065](D-065-inhabited-finish-line.md), [D-066](D-066-human-causal-boundary.md), [D-067](D-067-epistemic-revision.md).
