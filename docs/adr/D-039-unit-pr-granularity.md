...
Referenced by: [D-040](D-040-ci-and-junit.md), [D-063](D-063-outcome-first-delivery.md) (retains coherent singleton PRs and proportional locks while refusing count-shaped splits).
