...
table() {
  ...
  judge VerdictCensus 'VERDICT VERDICT_CENSUS_STATED unasked=75 unresolved=9 unmatched=17 read_none=0'
  ...
  # D-066 phase-two audit mapping (#1691). Frozen entries map bijectively in
