...
table() {
  ...
  # Twenty-two private source trees retain every reader branch, including the D-013
  # jack allowlist, a multiline transport, a same-line smuggle, and comment stripping.
  judge LatticeFence 'LATTICE SELFCHECK VERDICT READER_HOLDS cases=22 cases_none=0 failed=0' --selfcheck
