...
| Epistemic revision: carried tension and honest discharge | D-067 | 🟡 proposed | #1772 |
...
**Epistemic-revision decision DoD:** D-067 is proposed in #1772 because D-064 deliberately deferred mind-side scale/bounds and the implemented visible input cannot prove actual source independence or position exclusivity. Before #1697 runtime work, the Architect must choose carried-versus-derived state, tension/relation identity, admissible receipt-coupled OPEN/INCREASE/RETAIN/DECREASE/CLOSE causes, contradiction/corroboration authority, live tension/revision-lineage/biography bounds, the exact accountability invariant after compaction, overflow/archive/death disposition, atomicity and schema/digest/snapshot consequences. Governance and delivery are separate: this DECISIONS/ROADMAP gate is Human Foundation because D-067 elaborates accepted D-064 under D-066's noninterference constraint, while the #1772/#1697 milestone and branch phase tracker #1677 are Living Matrix Foundation delivery scheduling. A yellow gate is no permission to add resistance code.
