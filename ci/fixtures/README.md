...
## `neutral-baseline.chain` — the sealed pre-v6 chain

Sixty links: the full `DIGEST` chain of a canonical run — seed 42, 6,000 ticks,
headless — taken from `main` before Season Three's character layer changed
anything, ending at the sealed head
`4d1e827f98da7851c85754975812bbff1607d4909f5e5970a59ad19f4acf0759`.
